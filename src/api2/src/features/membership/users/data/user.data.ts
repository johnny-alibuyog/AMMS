...
const users = {
  superUser: new User({
    _id: new Types.ObjectId('5f23d935e328d5aa255de725'),
  ...
  adminUser: new User({
    _id: new Types.ObjectId('5f2e48a79737b4749f5605ba'),
  ...
  managerUser: new User({
    _id: new Types.ObjectId('5f2e499c682a9c80b15c22ef'),
  ...
  technicianUser1: new User({
    _id: new Types.ObjectId('5f2e4a5e21b907fa6ca9ab1c'),
  ...
  technicianUser2: new User({
    _id: new Types.ObjectId('5f326c73dde047c3b8a045ca'),
  ...
  technicianUser3: new User({
    _id: new Types.ObjectId('5f326c946b0405640ee0257e'),
  ...
  technicianUser4: new User({
    _id: new Types.ObjectId('5f326cc747cc0649a034d426'),
  ...
  technicianUser5: new User({
    _id: new Types.ObjectId('5f326ce29347cbf9530c264e'),
  ...
  technicianUser6: new User({
    _id: new Types.ObjectId('5f326eea13edfbfa5c4224d4'),
  ...
  technicianUser7: new User({
    _id: new Types.ObjectId('5f326ee463c90c74451ee371'),
  ...
  partsmanUser: new User({
    _id: new Types.ObjectId('5f2e49e28af9b7c03822a3f1'),
  ...
  accounting1User: new User({
    _id: new Types.ObjectId('5f2e4a4b41c20b07660ddbca'),
  ...
  accounting2User: new User({
    _id: new Types.ObjectId('5f2e4a401576914931e4f544'),
