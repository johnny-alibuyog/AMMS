Feature: Auth
  ...
  Scenario: User accessing resource without permission
    Given username "user.without.perms" with email "user.without.perms@gmail.com" and password "sample_password" does exists
  ...
  Scenario: User logs in with good credentials
    Given username "existing.user" with email "existing.user@gmail.com" and password "sample_password" does exists
  ...
  Scenario: User accessing resource with proper permission
    Given username "user.with.perms" with email "user.with.perms@gmail.com" and password "sample_password" does exists
